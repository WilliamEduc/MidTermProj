...
public class Payroll {
    ...
    public void InputEmployeeDetails() {
        ...
        try {
            ...
            // Employee Name validation - added loop to retry on empty input
            String employeeName;
            while (true) {
                System.out.print("Enter Full Name: ");
                employeeName = scanner.nextLine().trim();
                if (!employeeName.isEmpty() && !employeeName.matches(".*\\d.*")) {
                    this.setEmployeeName(employeeName);
                    break;
                }
            ...
            System.out.print("Enter Basic Monthly Salary PHP: ");
            double basicSalary = scanner.nextDouble();
            while (basicSalary < 0){
                System.out.print("Enter again. Enter Basic Monthly Salary PHPsymbol: ");
                basicSalary = scanner.nextDouble();
            }
            ...
            int overtimeHours = scanner.nextInt();
            while (overtimeHours < 0){
                System.out.print("Enter again. Enter Overtime Hours Worked: ");
                overtimeHours = scanner.nextInt();
            }
